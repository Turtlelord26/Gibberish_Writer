...
public class LinkedListTester {
  ...
  public void testContains() {
    LinkedList<Integer> list = new LinkedList<Integer>();
    assertEquals("Testing an element not in the list", false, list.contains(0));
    list.addToFront(7);
    assertEquals("Testing an element not in the list", false, list.contains(1));
    assertEquals("Testing the head element", true, list.contains(7));
    list.addToFront(8);
    assertEquals("Testing an element not in the list", false, list.contains(2));
    assertEquals("Testing the last element", true, list.contains(7));
    assertEquals("Testing the head element", true, list.contains(8));
    list.addToFront(9);
    assertEquals("Testing an element not in the list", false, list.contains(2));
    assertEquals("Testing the last element", true, list.contains(7));
    assertEquals("Testing the middle element", true, list.contains(8));
    assertEquals("Testing the head element", true, list.contains(9));
  }
